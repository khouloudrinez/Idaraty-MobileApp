<template>
  ...
  <ion-segment v-model="selectedSegment">
    <ion-segment-button value="administrations">
      Administrations
    </ion-segment-button>
  ...
  <ion-list>
    <ion-row>
      <ion-col v-for="(item, index) in itemsToShow" :key="index" size="6">
...
const administrationList = [
  ...
  { name: 'CNAM', description: 'Description ', image: "/idaratyy.png" },
  { name: 'CNSS', description: 'Description ', image: "/idaratyy.png" },
...
// Computed property to determine the list of items to display based on the selected segment
